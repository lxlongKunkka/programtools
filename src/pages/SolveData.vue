    ...
    <div class="task-list-panel">
      <div class="task-list-header">
        ...
        <div style="display:flex;gap:4px">
          ...
          <button @click="clearAllTasks" class="btn-icon" title="清空任务列表" style="color:#ef4444">???</button>
        </div>
      </div>
      <div class="task-list">
        <div
    ...
    <div class="detail-panel">
      ...
      <div class="detail-header">
        ...
        <div class="detail-actions">
          ...
          <button @click="clearAll" :disabled="isBatchRunning" class="btn-ghost btn-sm">??? 清空</button>
        </div>
      </div>
      ...
      <div class="step-content">
        ...
        <template v-else-if="activeTab === 'report'">
          <div class="tab-action-bar">
            ...
            <button @click="openReportNewWindow" :disabled="!reportHtml" class="btn-secondary btn-sm">↗? 新窗口</button>
...
`
    ...
    copyPureCode() {
      ...
      if (!code) {
        this.showToastMessage('?? 未找到可提取的代码')
        return
      }
