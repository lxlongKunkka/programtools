...
export class Unit {
  ...
  levelUp() {
      ...
      // Full heal on level up? (Standard in many games, but not specified. Let's assume no full heal, just stat bump)
      // Actually, usually level up heals. Let's keep it simple for now.
  }
}
