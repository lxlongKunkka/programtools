...
interface RecentEvent { t: number | null; ip: string | null; levelId: string | null; username: string | null; totalCommands: number | null; bestCommands: number | null; stars: number | null }
    ...
    <div className="lb-admin-overlay" onClick={onClose}>
      <div className="lb-stats-panel" onClick={e => e.stopPropagation()}>
        ...
        <div className="lb-stats-body">
          ...
          {data && tab === 'events' && (
            <table className="lb-stats-table">
              <thead><tr><th>时间</th><th>IP</th><th>用户</th><th>关卡</th><th>积木</th><th>最优</th><th>星级</th></tr></thead>
              <tbody>
