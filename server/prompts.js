...
6. **头文件规范**：C++ 代码统一使用 \`#include <bits/stdc++.h>\`，不再单独引入 iostream, algorithm 等其他头文件。
7. **严格要求**：模型在输出中必须使用美元符号来包裹所有公式、数字、变量和符号。如果输出中没有使用美元符号，请仍然以美元符号形式返回；不要删除或转义美元符号。`
...
2. **头文件规范**：C++ 代码统一使用 \`#include <bits/stdc++.h>\`，不要使用其他头文件
3. 代码要处理好输入输出
4. 代码要考虑边界情况
...
3. **结构**：
   ...
   - **代码实现页**：
     - **代码处理规则**：
       ...
       - **头文件规范**：C++ 代码统一使用 \`#include <bits/stdc++.h>\`，不再单独引入 iostream, algorithm 等其他头文件。
     - **注释要求**：
       - 关键变量定义处必须有注释说明含义。
...
10. **头文件规范**：C++ 代码统一使用 \`#include <bits/stdc++.h>\`，不再单独引入 iostream, algorithm 等其他头文件。
...
11. **头文件规范**：C++ 代码统一使用 \`#include <bits/stdc++.h>\`，不再单独引入 iostream, algorithm 等其他头文件。
...
8. **头文件规范**：C++ 代码统一使用 \`#include <bits/stdc++.h>\`，不再单独引入 iostream, algorithm 等其他头文件。
